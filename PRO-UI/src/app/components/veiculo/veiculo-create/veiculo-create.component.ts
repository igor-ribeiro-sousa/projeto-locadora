...
export class VeiculoCreateComponent implements OnInit {
  ...
  // anoString: string = this.hoje.getFullYear().toString();
  ...
  inserir(): void {
    if(this.validarInserir()){
      ...
      this.service.inserir(this.veiculo).subscribe(() => {
        this.toast.success('Veículo cadastrado com sucesso', 'Cadastro');
  ...
  completarInserir(): void {
    ...
    this.veiculo.flagAtivo = "S"
    this.veiculo.dataInclusao = new Date(); 
